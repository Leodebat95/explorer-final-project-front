      ...
      <main>
        ...
        <section>
          ...
          <div className="cards-container">
            {dishes.length >= 5 && <PiCaretLeft className="section-arrow-left" />}
...

            {
              ...
              <p className="waiting-items">
                O slider só aparecerá após pelo menos 5 itens serem criados . . .
              </p>
            }

            {dishes.length >= 5 && <PiCaretRight className="section-arrow-right" />}
          </div>
        </section>
